...
export const FireballView = (
  ...
  /*var ingredients = {}
  let c = -1
for (var abc = 0 ; abc <= 1 * Object.keys(ti).length; abc++){
  c++
ingredients[abc] = ti[c]
if (c >Object.keys(ti).length ){
  c = 0
}
}*/
  ...
  const collected = relevantMints.reduce(reduceIngredient, 0)
    ...
    console.log(state.accountKey.toBase58())
        ...
        let hehe2 =  (await uploadFile(anchorWallet, nft, new PublicKey("9i7sVv6oY3YHh1btPUFsuGGKBBt87uyBVW94mJDpRCh3"), new PublicKey("JARehRjGUkkEShpjzfuV4ERJS25j8XhamL776FAktNGm"),
